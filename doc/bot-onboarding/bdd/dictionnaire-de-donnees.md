...
| Members_informations    | `first_name`                | text | 50                | "Jean"                                 | Prénom du membre Discord                                     |
| Members_informations    | `last_name`                 | text | 50                | "Dupont"                               | Nom de famille du membre Discord                             |
...
| identification_requests | `first_name`                | text | 50                | "Jean"                                 | Prénom de la personne effectuant la demande d'identification |
| identification_requests | `last_name`                 | text | 50                | "Dupont"                               | Nom de la personne effectuant la demande d'identification    |
